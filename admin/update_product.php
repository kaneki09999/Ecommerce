...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="Enter Product description" name="description" maxlength="2000" class="box" value="<?= $fetch_products['description']; ?>">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Cleaning Appliances">Cleaning</option>
         <option value="Kitchen Appliances">Kitchen</option>
         <option value="Cooking Appliances">Cooking</option>
   ...
   <?php
         ...
         echo '<p class="empty">No Products Added et!</p>';
      }
   ?>
