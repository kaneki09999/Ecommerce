...
<body>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro" onclick="window.location.href='shop/product.php'">
                <img src="products/vacuum1.jpg" alt="">
                <div class="des">
                    <span>Panasonic</span>
                    <h5>Vacuum</h5>
    ...
    <div class="product-review">
        ...
        <div class="preview" data-target="p-1">
            ...
            <div class="buttons">
                <a href="login/logindex.php" class="buy">Buy now</a>
                <a href="login/logindex.php" class="cart">Add to cart</a>
            </div>
        </div>
