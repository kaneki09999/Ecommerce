...
<body>
    ...
    <a href="shop.php" class="dropbtn2">All</a>
<div class="dropdown">

<button class="dropbtn1">Cleaning Appliances</button>
...
<div class="dropdown">
<button class="dropbtn">Kitchen Appliances</button>
...
<section class="pro-container" style="padding-top: 0;">
        <section id="product1" class="section-p1">
            <section class="pro-container" style="padding-top: 0;">
                <?php
                $show_products = $conn->prepare("SELECT * FROM `z_insectsterilizer`");
